...
let textctrl = TextCtrl(panel, style=wTeReadOnly, value="""Szövegek helye, amit majd az adatbázisból kérek le nagy valószínűségge,
több nyelven is, mert talán errőlis tudok majd a későbbiekben írni a szakdolgozatomban.""")
